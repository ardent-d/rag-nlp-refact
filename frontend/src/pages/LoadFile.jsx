...
const LoadFile = () => {
  ...
  const handleProcess = async () => {
    ...
    try {
      ...
      // 新增参数
      if (loadingMethod === 'pymupdf' || loadingMethod === 'pdfplumber') {
      ...
      <div className="grid grid-cols-12 gap-6">
        ...
        <div className="col-span-3 space-y-4">
          <div className="p-4 border rounded-lg bg-white shadow-sm">
            ...
            {/* 仅在pymupdf和pdfplumber时显示参数 */}
            {(loadingMethod === 'pymupdf' || loadingMethod === 'pdfplumber') && (
              <>
                <div className="mt-4">
                  <label className="block text-sm font-medium mb-1">Page Range (e.g. 1-5 or 2,4,6)</label>
                  <input
                    type="text"
                    value={pageRange}
